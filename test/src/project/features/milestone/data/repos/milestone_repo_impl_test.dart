...
void main() {
  ...
  group('getMilestones', () {
    test(
      'should return [MilestoneCollectionSnapshot] when call'
      ...
      () async {
        ...
        expect(
          result,
          equals(const Right<Failure, MilestoneCollectionSnapshot>(tSnapshot)),
        );
    ...
    test(
      ...
      () async {
        ...
        expect(
          result,
          equals(
            Left<Failure, MilestoneCollectionSnapshot>(
  ...
  group('reorderMilestone', () {
    test(
      ...
      () async {
        ...
        final result = await repoImpl.reorderMilestone(
          projectId: tProjectId,
          milestoneId: tMilestone.id,
