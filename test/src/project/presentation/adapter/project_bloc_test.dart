...
class MockGetUserTools extends Mock implements GetUserTools {}

class MockRemoveUserTool extends Mock implements RemoveUserTool {}
...
void main() {
  ...
  late GetUserTools getUserTools;
  late RemoveUserTool removeUserTool;
  ...
  setUp(() {
    ...
    removeUserTool = MockRemoveUserTool();
    bloc = ProjectBloc(
  ...
  setUpAll(() {
    registerFallbackValue(const GetProjectsParams.empty());
  });
  ...
  group('addProject', () {
    ...
    blocTest<ProjectBloc, ProjectState>(
      ...
      act: (bloc) => bloc.add(AddProjectEvent(tProject)),
      expect: () => [
  ...
  group('deleteProject', () {
    ...
    blocTest<ProjectBloc, ProjectState>(
      ...
      act: (bloc) => bloc.add(const DeleteProjectEvent(tProjectId)),
      expect: () => [
        const ProjectLoading(),
  ...
  group('editProjectDetails', () {
    ...
    blocTest<ProjectBloc, ProjectState>(
      ...
      act: (bloc) => bloc.add(
        const EditProjectDetailsEvent(projectId: tProjectId, updateData: {}),
      ),
      expect: () => [
        const ProjectLoading(),
  ...
  group('getProjectById', () {
    ...
    blocTest<ProjectBloc, ProjectState>(
      ...
      act: (bloc) => bloc.add(const GetProjectByIdEvent(tProjectId)),
      expect: () => [
        const ProjectLoading(),
  ...
  group('getProjects', () {
    ...
    blocTest<ProjectBloc, ProjectState>(
      ...
      act: (bloc) => bloc.add(const GetProjectsEvent()),
      expect: () => [
        const ProjectLoading(),
