...
void main() {
  ...
  group('addClient', () {
    ...
    test("should update totalEarned for the currentUser's document "
  ...
  group('deleteClient', () {
    ...
    test("should update totalEarned for the currentUser's document when "
        'deleting a client', () async {
      // ARRANGE
      final tClient = ClientModel.empty();
      final client = await remoteDataSrc.addClient(tClient);
      final initialTotalEarned =
          (await firebase.firestore
                      .collection('users')
                      .doc(tCurrentUser.uid)
                      .get())
