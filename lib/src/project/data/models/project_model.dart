...
class ProjectModel extends Project {
  const ProjectModel({
    ...
    super.featureImageStoragePath,
    super.ownedStoragePaths,
  });
  ...
  ProjectModel.fromMap(DataMap map)
    : this(
        ...
        urls: map['urls'] != null
            ? List<DataMap>.from(
                map['urls'] as List<dynamic>,
              ).map(URLModel.fromMap).toList()
            : [],
        ...
        numberOfMilestonesSoFar: (map['numberOfMilestonesSoFar'] as num)
            .toInt(),
        ...
        deletionRequestedAt: (map['deletionRequestedAt'] as Timestamp?)
            ?.toDate(),
        featureImageStoragePath: map['featureImageStoragePath'] as String?,
        ownedStoragePaths:
            (map['ownedStoragePaths'] as List<dynamic>?)
                ?.whereType<String>()
                .toList() ??
            const <String>[],
      );
  ...
  DataMap toMap() {
    return <String, dynamic>{
      ...
      if (ownedStoragePaths.isNotEmpty) 'ownedStoragePaths': ownedStoragePaths,
    };
  }
}
